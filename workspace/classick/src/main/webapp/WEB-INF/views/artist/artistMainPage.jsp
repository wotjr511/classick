						...
						$.each(list, function(idx, map){
							...
							.append(
								...
								.append(
										...
										.append('<a class="go-artistHome" id="go-artistHome'+idx+'" href="javascript:void(0)">작가 홈</a>')
								)	
							)
							.append(
							...
							.appendTo($('.artistList'));
							$('#go-artistHome'+idx).click(function(){
								location.href='artistHomePage.do?aNo='+map.ANO;
							});

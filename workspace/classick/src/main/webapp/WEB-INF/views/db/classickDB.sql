...
INSERT INTO ARTIST VALUES(ARTIST_SEQ.NEXTVAL, 21, '디디얌', '디디얌 베이커리&디저트', 'artist3.jpg', 'artistBanner3.jpg');
...
-- 수제 반찬
INSERT INTO PRODUCT VALUES (PRODUCT_SEQ.NEXTVAL, '🔵농부 의성마늘쫑🔵 (마늘은 의성)입맛살아요', 'handmade-sideDishes1.jpg&', 8900, 5900, '수제반찬', '#장아찌', 10, '🔴마늘쫑은 의성!🔴'||chr(13)||chr(10)||
'🔴의성부자농장 마늘쫑🔴'||chr(13)||chr(10)||'
왜!? 마늘쫑은 의성인지 드셔보시면 느끼실거에요'||chr(13)||chr(10)||'
▶▶▶의성부자농장 3가지 약속◀◀◀'||chr(13)||chr(10)||'
🔵맛있는 의성부자농장 100% 수제 농부 마늘쫑 장아찌🔵'||chr(13)||chr(10)||'
(공장에서 찍어내는 장아찌 아닙니다)'||chr(13)||chr(10)||'
🔵농장 직거래를 통한 부담없는 국민가격🔵'||chr(13)||chr(10)||'
(아이디어스 최저가! 저희 농장 이윤을 일부러 줄입니다)'||chr(13)||chr(10)||'
🔵식재료를 직접 재배하는 건강한 믿음 장아찌🔵'||chr(13)||chr(10)||'
(식재료 안전한 직접재배!)'||chr(13)||chr(10)||'
...
INSERT INTO PRODUCT VALUES (PRODUCT_SEQ.NEXTVAL, '🔵 삭힌 깻잎김치 🔵 (이건 진짜에요)농장 직거래', 'handmade-sideDishes2.jpg&', 9900, 7900, '수제반찬', '#김장김치', 10, '🔷깻잎에 양념만 바른거 아니에요🔷'||chr(13)||chr(10)||'
🔹️저희농장에서 직접 삭힌 깻잎김치🔹️'||chr(13)||chr(10)||'
🔷드셔보시면 다릅니다🔷'||chr(13)||chr(10)||'
▶▶▶의성부자농장 3가지 약속◀◀◀'||chr(13)||chr(10)||'
🔵맛있는 의성부자농장 100% 수제 농부 김치🔵'||chr(13)||chr(10)||'
(공장에서 찍어내는 김치 아닙니다)'||chr(13)||chr(10)||'
(김치는 맛있어야 합니다)'||chr(13)||chr(10)||'
🔵농장 직거래를 통한 부담없는 국민가격🔵'||chr(13)||chr(10)||'
(아이디어스 최저가! 저희 농장 이윤을 일부러 줄입니다)'||chr(13)||chr(10)||'
(가격부담없이 드셔주세요)'||chr(13)||chr(10)||'
🔵식재료를 직접 재배하는 건강한 믿음 김치🔵'||chr(13)||chr(10)||'
(식재료 안전한 직접재배!)'||chr(13)||chr(10)||'
(식자재 부족시에만 친한농장들 일부 재료 수매)', '{"제작배송방법":"주문 후 제작에 들아가는 제품입니다.","교환환불내용":"주문 전 판매 작가님과 연락하여 확인해주세요.","제작배송기간":"4","배송비":"4000","도서산간비용":"3000","교환환불정책":"조건확인","무료배송":"70000"}', NULL, 5, SYSDATE);

INSERT INTO PRODUCT VALUES (PRODUCT_SEQ.NEXTVAL, '🔴농부가 만드는 시골 (봄동+청방) 짜박 김치🔴', 'handmade-sideDishes3.jpg&', 14900, 10900, '수제반찬', '#봄동김치', 10, '🔴농부가 만드는 시골 (봄동+청방) 짜박 김치🔴'||chr(13)||chr(10)||
'국물이 자박자박하다고 해서'||chr(13)||chr(10)||'
짜박이 김치라고 부르지요~'||chr(13)||chr(10)||'
▶▶▶의성부자농장 3가지 약속◀◀◀'||chr(13)||chr(10)||'
🔵맛있는 의성부자농장 100% 수제 농부 김치/반찬🔵'||chr(13)||chr(10)||'
(공장에서 찍어내는 김치/반찬 아닙니다)'||chr(13)||chr(10)||'
(김치와 반찬은 맛있어야 합니다)'||chr(13)||chr(10)||'
🔵농장 직거래를 통한 부담없는 국민가격🔵'||chr(13)||chr(10)||'
(아이디어스 최저가! 저희 농장 이윤을 일부러 줄입니다)'||chr(13)||chr(10)||'
(가격부담없이 드셔주세요)'||chr(13)||chr(10)||'
🔵식재료를 직접 재배하는 건강한 믿음 김치/반찬🔵'||chr(13)||chr(10)||'
(식재료 안전한 직접재배!)'||chr(13)||chr(10)||'
...
INSERT INTO PRODUCT VALUES (PRODUCT_SEQ.NEXTVAL, '🔵농부손맛 총각김치 1kg(통)-(라면하고 찰떡궁합)', 'handmade-sideDishes4.jpg&', 13900, 10900, '수제반찬', '#알타리무총각무', 10, '🔴총각김치 없이 라면드실꺼예요?🔴'||chr(13)||chr(10)||
'발송 당일 바로담아서 보내드립니다~^^'||chr(13)||chr(10)||'
하루이틀 상온숙성후 드시면 밥반찬에도 라면에도 필수인 김치'||chr(13)||chr(10)||'
▶▶▶의성부자농장 3가지 약속◀◀◀'||chr(13)||chr(10)||'
🔵맛있는 의성부자농장 100% 수제 농부 김치/반찬🔵'||chr(13)||chr(10)||'
(공장에서 찍어내는 김치/반찬 아닙니다)'||chr(13)||chr(10)||'
(김치와 반찬은 맛있어야 합니다)'||chr(13)||chr(10)||'
...
'▶▶▶의성부자농장 3가지 약속◀◀◀'||chr(13)||chr(10)||'
🔵맛있는 의성부자농장 100% 수제 김치,반찬류🔵'||chr(13)||chr(10)||'
(공장에서 찍어내는 반찬이 아닙니다)'||chr(13)||chr(10)||'
(반찬은 맛있어야 합니다)'||chr(13)||chr(10)||'
🔵농장 직거래를 통한 부담없는 국민가격🔵'||chr(13)||chr(10)||'
(아이디어스 최저가! 저희 농장 이윤을 일부러 줄입니다)'||chr(13)||chr(10)||'
(가격부담없이 드셔주세요)'||chr(13)||chr(10)||'
🔵식재료를 직접 재배하는 건강한 믿음 장아찌🔵'||chr(13)||chr(10)||'
...
'💖면역력 강화! 마늘 반찬💖'||chr(13)||chr(10)||'
아삭아삭 마늘 장아찌+마늘쫑'||chr(13)||chr(10)||'
👍장시간 숙성시켜 마늘의 매운맛은no!!'||chr(13)||chr(10)||'
👍면역력을 올려주는 아삭한 통마늘'||chr(13)||chr(10)||'
👍첨가물 없이 만든 건강한 매콤 상큼 특제 양념'||chr(13)||chr(10)||'
아삭아삭하고 매콤 상큼한 마늘과'||chr(13)||chr(10)||'
골라먹는 재미가 쏠쏠한 마늘쫑'||chr(13)||chr(10)||'
마늘의 매운맛을 없애기 위해'||chr(13)||chr(10)||'
물엿에 마늘을 재웠습니다~'||chr(13)||chr(10)||'
조금 쭈글쭈글한 마늘이 있을 수 있는 점'||chr(13)||chr(10)||'
...
'💖세트상품 이벤트💖'||chr(13)||chr(10)||'
순살간장게장(150g)+순살양념게장(150g)'||chr(13)||chr(10)||'
순살간장게장(250g)+순살양념게장(250g)'||chr(13)||chr(10)||'
순살간장게장(250g)+순살양념게장(250g)+선물포장'||chr(13)||chr(10)||'
(❗맛변경은 되지 않습니다)'||chr(13)||chr(10)||'
(❗150g은 선물포장이 되지않습니다)'||chr(13)||chr(10)||'
💖감사한 분들께 선물하세요💖'||chr(13)||chr(10)||'
맛있는 순살게장+고급스러운 라벨과 포장+'||chr(13)||chr(10)||'
안전한 보냉백에 아이스 팩+부직포 가방'||chr(13)||chr(10)||'
✔자극적인 조미료 뺴고 건강한 순살!'||chr(13)||chr(10)||'
✔신선하고 큰 꽃게를 직거래로 받아 항상 싱싱하게!'||chr(13)||chr(10)||'
...
'바다의 제왕! 고칼슘 젓갈!'||chr(13)||chr(10)||'
🐟저염 갈치속젓🐟'||chr(13)||chr(10)||'
갈치속젓은 갈치의 내장을 천일염으로'||chr(13)||chr(10)||'
삭혀 만드는 젓갈로 특히 내장, 뱃살에'||chr(13)||chr(10)||'
칼슘이 많아 영양만점 식품이에요~👍'||chr(13)||chr(10)||'
셰프가 만들어 더욱 특별하고 갈치 특유의'||chr(13)||chr(10)||'
비린맛을 제거해 부담없이 즐겨 먹기 좋아요!🍚❤'||chr(13)||chr(10)||'
또한 멸치에 들어간 알라닌은 면역계를 증강시키는'||chr(13)||chr(10)||'
효능이 있어 어른신들 선물로도 좋습니다😘👍'||chr(13)||chr(10)||'
👨‍🍳어떠한 첨가물도 없는 건강함~'||chr(13)||chr(10)||'
👨‍🍳신안천일염으로 더욱 더 풍부한 감칠맛~'||chr(13)||chr(10)||'
...
'❤️❤️밥반찬이나 안주로도 최고❤️❤️'||chr(13)||chr(10)||'
꼬막 더 맛있게 먹는 방법'||chr(13)||chr(10)||'
✔따끈따끈한 밥에 꼬막장과'||chr(13)||chr(10)||'
참기름, 계란 반숙, 김가루 올려 쓱쓱 비벼먹기!'||chr(13)||chr(10)||'
✔꼬막장에 참기름을 조금~넣고'||chr(13)||chr(10)||'
소면이나 쫄면과 함께 비벼주시면 완벽한 술안주!'||chr(13)||chr(10)||'
👍귀찮은건 다 해드려요~껍질 없는 꼬막'||chr(13)||chr(10)||'
👍믿고 먹을 수 있는 건강한 셰프의 특제 양념장!'||chr(13)||chr(10)||'
👍밥에 참기름 넣고 비벼만 줘도 꼬막맛집 인정~'||chr(13)||chr(10)||'
✨✨중독적인 맛 2가지✨✨'||chr(13)||chr(10)||'
✔기본 양념(어린아이들도 먹을 수 있는 맵기)'||chr(13)||chr(10)||'
...
'인기가 너무 많아요~ ✨젓갈반찬 낙지젓✨'||chr(13)||chr(10)||'
오동통하고 탱글한 식감의 낙지를 한입크기로 염지했어요~'||chr(13)||chr(10)||'
짜거나 달거나 자극적인 젓갈 NO~'||chr(13)||chr(10)||'
좋은 재료로 건강하게 만들었어요💖'||chr(13)||chr(10)||'
✔1달간의 저온 숙성 양념장으로 감칠맛 업!'||chr(13)||chr(10)||'
✔매일 먹어도 질리지 않는 데일리반찬 낙지젓갈'||chr(13)||chr(10)||'
✔없던 입맛도 살리는 중독적인 맛'||chr(13)||chr(10)||'
그냥 따뜻한 밥이랑 먹어도~'||chr(13)||chr(10)||'
볶음밥 비빔밥으로 해먹어도~'||chr(13)||chr(10)||'
참기름을 살짝 넣어 밥이랑 먹어도~'||chr(13)||chr(10)||'
✨너무 맛있어요✨'||chr(13)||chr(10)||'
구매하신 분들 모두 100% 재구매🥰'||chr(13)||chr(10)||'
...
'국산생강을 저온 발효숙성하여'||chr(13)||chr(10)||'
생강 본연의 맛과 향을 그대로 담은 생강청!'||chr(13)||chr(10)||'
지금 이 계절~'||chr(13)||chr(10)||'
집집마다 한병씩은 꼭 있는 비상 상비약!'||chr(13)||chr(10)||'
환절기, 감기기운있을때, 몸이 으슬으슬할때'||chr(13)||chr(10)||'
생강청 한잔이면 뚝~~!!!'||chr(13)||chr(10)||'
발효숙성생강청은'||chr(13)||chr(10)||'
✔국산봉동생강으로 물한방울 넣지 않고'||chr(13)||chr(10)||'
생강을 착즙하여 만든 고농축생강청 입니다.'||chr(13)||chr(10)||'
✔착즙한 생강의 전분을 제거하여'||chr(13)||chr(10)||'
차로, 라떼로 드실때 훨씬 더 부드럽습니다.'||chr(13)||chr(10)||'
✔저온으로 숙성하여 더~ 깊은맛을 느끼실수 있습니다.'||chr(13)||chr(10)||'
...
'건강한 선물'||chr(13)||chr(10)||'
대추도라지정과와 도라지양갱,'||chr(13)||chr(10)||'
모듬견과강정까지 한번에 담은 선물세트!'||chr(13)||chr(10)||'
푸짐한 양으로 넉넉한 선물하세요 :)'||chr(13)||chr(10)||'
대추도라지정과는 100%자연건조로 건조해요.'||chr(13)||chr(10)||'
건조기로 말린 도라지정과랑은 비교불가X'||chr(13)||chr(10)||'
쫀득함이 다르답니다~'||chr(13)||chr(10)||'
3일간 끓이고 식히고를 반복한뒤,'||chr(13)||chr(10)||'
잘 당침된 도라지를 7일동안 자연으로 건조합니다.'||chr(13)||chr(10)||'
모듬견과강정은,'||chr(13)||chr(10)||'
특A급 견과류를 갓구워 만들어요~'||chr(13)||chr(10)||'
호두, 피칸, 땅콩, 해바라기씨, 호박씨를'||chr(13)||chr(10)||'
...
'도라지와 대추를 정성껏 달여 만든'||chr(13)||chr(10)||'
엑기스만 담은 대추도라지진액청 !!'||chr(13)||chr(10)||'
도라지와 대추, 조청을 3일간 정성껏 달여 나온 진액으로,'||chr(13)||chr(10)||'
물한방울 넣지 넣지 않고'||chr(13)||chr(10)||'
오직 도라지,대추,조청만 넣어 만든 진액청 입니다.'||chr(13)||chr(10)||'
물을 넣지 않고 달이기 때문에 아주 소량만 나오는'||chr(13)||chr(10)||'
귀한 진액 이여요~~!!'||chr(13)||chr(10)||'
정성이 들어간 아주 귀한 음식입니다.'||chr(13)||chr(10)||'
물엿이나 설탕, 색소, 방부제는 일절들어가지 않습니다!!'||chr(13)||chr(10)||'
도라지와 대추 조청을 오랜시간 달였기 때문에'||chr(13)||chr(10)||'
찐득한 깊은맛을 느끼실수 있어요.'||chr(13)||chr(10)||'
첫맛은 조청과 대추의 달콤함을'||chr(13)||chr(10)||'
끝맛은 도라지의 씁쓸함을 느끼실수 있어요.'||chr(13)||chr(10)||'
쓴맛이 많이 나지 않아요.'||chr(13)||chr(10)||'
...
'촉촉하고 부드러운 오란다~~'||chr(13)||chr(10)||'
견과류가 콕콕! 건강한 오란다~'||chr(13)||chr(10)||'
여기 오란다~~ 있어요!'||chr(13)||chr(10)||'
쌀조청으로 만든 건강한 오란다!'||chr(13)||chr(10)||'
설탕X 물엿X'||chr(13)||chr(10)||'
조청으로 만들어 부드러워요:)'||chr(13)||chr(10)||'
건강한 단맛으로 멈출수 없는 맛!!!'||chr(13)||chr(10)||'
견과류까지 콕콕~ 토핑이 있어 더 맛있어요~'||chr(13)||chr(10)||'
심심한맛을 견과류가 살려준답니다.'||chr(13)||chr(10)||'
견과류도 다~ 전처리하여 사용하기 때문에 훨씬 고소해요!'||chr(13)||chr(10)||'
부드럽지만 이에 붙지않아 더 좋은 오란다~'||chr(13)||chr(10)||'
어린아이부터 할머니 할아버지까지~~'||chr(13)||chr(10)||'
모두 좋아하는 오란다~!'||chr(13)||chr(10)||'
딱딱하지 않아 누구나 드실수 있습니다'||chr(13)||chr(10)||'
...
'♥고농축 과일청이라'||chr(13)||chr(10)||'
일반 슬라이스 청보다 과일의 비율이 높아'||chr(13)||chr(10)||'
풍부한 과일향과 진한 맛을 느낄 수 있답니다.'||chr(13)||chr(10)||'
♥식용구연산을 사용하지 않고,'||chr(13)||chr(10)||'
직접 만든 황금비율의 레몬청으로 맛을 살려줘요.'||chr(13)||chr(10)||'
♥특별한 비법으로 병입시 분리를 최소화 했어요~!'||chr(13)||chr(10)||'
♥기존의 과일청보다 소량으로도 과일청맛을 UP 시켜줘요~!!'||chr(13)||chr(10)||'
♥길쭉한 병으로 숟가락 NONO!'||chr(13)||chr(10)||'
쪼로록 따르기만하면 OK~~!!'||chr(13)||chr(10)||'
깔끔하게 과일청을 즐길수 있어요~~'||chr(13)||chr(10)||'
...
'★Only 마늘과 벌꿀만 들어갑니다!!★'||chr(13)||chr(10)||'
꿀마늘 맛은?'||chr(13)||chr(10)||'
거부감 없는 맛이예요!'||chr(13)||chr(10)||'
저는 처음 딱 먹어보고 든 생각은,'||chr(13)||chr(10)||'
마늘빵의 그 마늘스프레드 맛!! 이였어요.'||chr(13)||chr(10)||'
마늘을 쪄서 만들었기 때문에 전혀 매운맛이 없답니다.'||chr(13)||chr(10)||'
포슬포슬한 맛과 벌꿀맛이 어우려져 달콤해요:)'||chr(13)||chr(10)||'
부모님, 조부모님께 선물하면 무지 좋을것 같아요.'||chr(13)||chr(10)||'
주위에 뇌,혈관건강 고민하시는 분께도 추천드립니다!'||chr(13)||chr(10)||'
🚫반드시 냉장보관 해주세요 !!'||chr(13)||chr(10)||'
...
'보는것도 이쁘고, 맛도좋은~!!'||chr(13)||chr(10)||'
자몽이 듬뿍~들어간 자몽청!'||chr(13)||chr(10)||'
자몽 특유의 쓴맛을 제거하여 더 맛있어요:)'||chr(13)||chr(10)||'
알알이 자몽의 맛을 느낄수 있어요~~'||chr(13)||chr(10)||'
한길로의 고농축 과일청이 더 특별한 이유!!'||chr(13)||chr(10)||'
♥식용구연산을 사용하지 않고,'||chr(13)||chr(10)||'
직접 만든 황금비율의 레몬청으로 맛을 살려줘요'||chr(13)||chr(10)||'
♥특별한 비법으로 병입시 분리를 최소화 했어요~!'||chr(13)||chr(10)||'
♥기존의 과일청보다 소량으로도 과일청맛을 UP 시켜줘요~!!'||chr(13)||chr(10)||'
...
'모과의 계절이 왔어요 ~~!!!'||chr(13)||chr(10)||'
청도 햇 모과로 만든 모과청~~'||chr(13)||chr(10)||'
향이 좋은 모과에 토종벌꿀을 듬뿍~ 넣은 꿀모과청 !!'||chr(13)||chr(10)||'
모과가 꿀에 절여지도록 토종벌꿀을 듬뿍 넣어 만든 청입니다 ~^^'||chr(13)||chr(10)||'
향긋한 모과향에 벌꿀향까지~~ 향만 맡아도 따뜻해지는 기분이예요.'||chr(13)||chr(10)||'
못생긴과일 모과, 딱딱해서 작업하기도 힘들지만,'||chr(13)||chr(10)||'
작업하기 힘든게 원래 맛도 더 좋아요~ㅎㅎ'||chr(13)||chr(10)||'
이계절, 꼭 드셔야 합니다~~^^'||chr(13)||chr(10)||'
목이 칼칼하고 몸이 으슬으슬 할때~'||chr(13)||chr(10)||'
따뜻한 모과차 한잔이면 몸이 한결 낳아지실거예요~'||chr(13)||chr(10)||'
🚫드실 때 꼭 흔들어서 잘섞은후 따라주세요.'||chr(13)||chr(10)||'
...
'베리베리~ 다모여라!!'||chr(13)||chr(10)||'
베리들의 총집합~!! 베리청!!'||chr(13)||chr(10)||'
블루베리, 라즈베리, 블랙베리, 스트로베리까지~~!!'||chr(13)||chr(10)||'
모두 한곳에 담은 베리청 입니다!'||chr(13)||chr(10)||'
한길로의 고농축 과일청이 더 특별한 이유!!'||chr(13)||chr(10)||'
♥식용구연산을 사용하지 않고,'||chr(13)||chr(10)||'
직접 만든 황금비율의 레몬청으로 맛을 살려줘요.'||chr(13)||chr(10)||'
♥특별한 비법으로 병입시 분리를 최소화 했어요~!'||chr(13)||chr(10)||'
...
'소화가 안되고 더부룩할때 ,'||chr(13)||chr(10)||'
느끼한 음식을 많이 먹었을때~'||chr(13)||chr(10)||'
시원~~한 수정과 한잔 드시면 불편한 속을 달래주어요.'||chr(13)||chr(10)||'
마트에 파는 수정과 드시고 밍밍해서 실망한적 많으시죠?'||chr(13)||chr(10)||'
한길로 수정과는 집에서 정성껏 끓인 엄마가 해주신 그 수정과~'||chr(13)||chr(10)||'
그맛 이예요~~!! 정말 추천합니다 ~^^'||chr(13)||chr(10)||'
수정과에 고명으로 잣,대추,곶감을 곁들이면'||chr(13)||chr(10)||'
손님맞이 음료로 정말 좋습니다 ~~^^'||chr(13)||chr(10)||'
◆1병 - 500ml◆'||chr(13)||chr(10)||'
◆방부제가 일절 들어가 있지 않습니다◆'||chr(13)||chr(10)||'
...
'💝두병선물포장 옵션선택 가능합니다💝'||chr(13)||chr(10)||'
*단병은 선물패키지 및 소박스가 준비되어있지 않습니다*'||chr(13)||chr(10)||'
특색있는 이색주'||chr(13)||chr(10)||'
주원료인 홍국쌀은'||chr(13)||chr(10)||'
쌀에 붉은색을 띠는 곰팡이를'||chr(13)||chr(10)||'
고체로 발효한 뒤'||chr(13)||chr(10)||'
쌀을 발효시켜 만드는 쌀입니다.'||chr(13)||chr(10)||'
이 술이 띄고 있는'||chr(13)||chr(10)||'
장미빛의 붉은색은'||chr(13)||chr(10)||'
술취한 원숭이만의 트레이드마크로써'||chr(13)||chr(10)||'
합성감미료뿐 아니라'||chr(13)||chr(10)||'
색소조차 들어가지 않은'||chr(13)||chr(10)||'
...
'💝두병선물포장 옵션선택 가능합니다💝'||chr(13)||chr(10)||'
*단병은 선물패키지 및 소박스가 준비되어있지 않습니다*'||chr(13)||chr(10)||'
2018년 문재인대통령의 만찬주 건배주로서'||chr(13)||chr(10)||'
청와대에도 들어간 그 술!'||chr(13)||chr(10)||'
깔끔한 우리의 맑은 술'||chr(13)||chr(10)||'
인생에서 가장 값진 선물은 인연입니다.'||chr(13)||chr(10)||'
그 소중한 인연에 감사하는 마음으로'||chr(13)||chr(10)||'
맵쌀로 정성들여 빚은 우리의 맑은 술로써'||chr(13)||chr(10)||'
끈적거리지 않는 깔끔함으로'||chr(13)||chr(10)||'
...
'🍯국내산 천연꿀 리큐르 꿀샘16🍯'||chr(13)||chr(10)||'
국내산 천연꿀이 첨가된 꿀리큐르(소주)가 출시되었습니다!'||chr(13)||chr(10)||'
16도 술이라는 사실이 믿기지 않을 정도로 부드럽고,'||chr(13)||chr(10)||'
달콤한 벌꿀향이 일품👍'||chr(13)||chr(10)||'
꿀이 들어갔다고 해서 과하게 달지 않아요!'||chr(13)||chr(10)||'
적당한 단맛과 알콜의 밸런스가 매우 좋은 꿀샘16입니다.'||chr(13)||chr(10)||'
알코올도수는 16도 일반 소주와 비슷하지만 알코올 향 대신 벌꿀의 은은한 향을 느낄 수 있으며'||chr(13)||chr(10)||'
목넘김이 매우 부드러워요! 남녀노소 즐길 수 있는 우리술 입니다:)'||chr(13)||chr(10)||'
...
'술샘16은 국내산오미자100%를 침출하여'||chr(13)||chr(10)||'
과실의 맛과 향을 살린 술입니다'||chr(13)||chr(10)||'
오미자 특유의 5가지 (신맛,단맛,쓴맛,매운맛,짠맛) 신비한'||chr(13)||chr(10)||'
맛을 느낄 수 있습니다🤩'||chr(13)||chr(10)||'
한모금 마셨을때 입안에 가득 퍼지는 오미자의'||chr(13)||chr(10)||'
향과 맛이 일품입니다'||chr(13)||chr(10)||'
오미자를 그대로 입안에 머금은 듯한 착각을 불러일으킬'||chr(13)||chr(10)||'
정도로 오미자의 순수한 맛을 증류주에 담았습니다🤲'||chr(13)||chr(10)||'
술샘16의 오미자는 국내산100%를 고집합니다'||chr(13)||chr(10)||'
중국산의 3배가량 비싸지만'||chr(13)||chr(10)||'
술샘은 원재료에 대한 확고한 원칙과 신념을 우선 합니다'||chr(13)||chr(10)||'
❣️술샘16을 사이다 혹은 탄산수와 섞어 오미자 칵테일로 즐겨보세요 무더운 여름 지친 여러분'||chr(13)||chr(10)||'
...
'술샘의 미르시리즈는'||chr(13)||chr(10)||'
전통 증류방식소주입니다🙌'||chr(13)||chr(10)||'
오로지'||chr(13)||chr(10)||'
쌀,물,누룩으로만 빚은 고급주이구요'||chr(13)||chr(10)||'
쌀은'||chr(13)||chr(10)||'
엄선된 경기미안을 사용하여'||chr(13)||chr(10)||'
최상의 품질을 자랑합니다.'||chr(13)||chr(10)||'
상압증류로'||chr(13)||chr(10)||'
진한 곡향이 예술인 미르시리즈,'||chr(13)||chr(10)||'
중국산의 3배가량 비싸지만'||chr(13)||chr(10)||'
이젠 다양하게'||chr(13)||chr(10)||'
...
영업일 기준 보통 ‘다음날’ 도착하니 참고해주세요!❤️'||chr(13)||chr(10)||'
은은한 생강향과 강황의 예쁜 노란빛이 조화로운 술샘19출시'||chr(13)||chr(10)||'
리큐르 19%💛'||chr(13)||chr(10)||'
술샘19은 생강과 강황을 침출하여'||chr(13)||chr(10)||'
생강의 맛과 향을 살린 술입니다'||chr(13)||chr(10)||'
은은하고 살짝 알싸한 생강향과 예쁜 노란빛이 특징입니다🤩'||chr(13)||chr(10)||'
생강의 너무 강하지도 약하지도 않은 향을 조화롭게 증류주에 담았습니다🤲'||chr(13)||chr(10)||'
술샘은 원재료에 대한 확고한 원칙과 신념을 우선 합니다'||chr(13)||chr(10)||'
❣️술샘19를 사이다 혹은 진저에일과 섞어 칵테일로 즐겨보세요 '||chr(13)||chr(10)||'
...
'전통주업계의 최고 권위있는대회인'||chr(13)||chr(10)||'
‘2018우리술품평회’에서'||chr(13)||chr(10)||'
술샘의 미르40이'||chr(13)||chr(10)||'
최고상인'||chr(13)||chr(10)||'
✨대통령상✨을 수상하여'||chr(13)||chr(10)||'
올해 최고의 술임을 인정받았습니다👏🏻'||chr(13)||chr(10)||'
미르25/40/54'||chr(13)||chr(10)||'
술샘의 미르시리즈는'||chr(13)||chr(10)||'
전통 증류방식소주입니다🙌'||chr(13)||chr(10)||'
오로지'||chr(13)||chr(10)||'
쌀,물,누룩으로만 빚은 고급주이구요,'||chr(13)||chr(10)||'
...
'🍒오색식초🍒'||chr(13)||chr(10)||'
머루,오디,오미자,매실,복분자로 구성된 오색식초는 옹기속에서 백일을 정성으로 식초를 만든후, 저온에서 이백일 이상 숙성시킨 전통발효식초입니다.'||chr(13)||chr(10)||'
정성으로 만든 우리식초, 소중한 분께 성물 어떠새요?'||chr(13)||chr(10)||'
✅믿을 수 있는 체크포인트✅'||chr(13)||chr(10)||'
국내산 재료와 농촌진흥청의 특별한 발효기술이 결합해 만들어진 천연발효식초!'||chr(13)||chr(10)||'
엄선된 초산균으로 2차발효법을통해 발효시켜'||chr(13)||chr(10)||'
향과 초산생성율이 월등히 높습니다.'||chr(13)||chr(10)||'
국내산 머루,오미자,매실,복분자,오디만을 100%사용하여 옹기에서 장기간숙성!'||chr(13)||chr(10)||'
아미노산과 유기산이 풍부합니다'||chr(13)||chr(10)||'
각종요리에 일반식초와 동일하게 사용하시거나'||chr(13)||chr(10)||'
